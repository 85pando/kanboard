...
return array(
    ...
    'Close a task when there is no activity in an specific column' => 'Eine Aufgabe schließen, wenn es in einer spezifischen Spalte keine Aktivität mehr gibt',
    '%s removed a subtask for the task #%d' => '%s hat eine Unteraufgabe für die Aufgabe #%d entfernt',
    '%s removed a comment on the task #%d' => '%s hat einen Kommentar in der Aufgabe #%d entfernt',
    'Comment removed on task #%d' => 'Kommentar in Aufgabe #%d entfernt',
    'Subtask removed on task #%d' => 'Unteraufgabe in Aufgabe #%d entfernt',
    ...
    '%s removed a subtask for the task %s' => '%s hat eine Unteraufgabe für die Aufgabe %s entfernt',
    'Comment removed' => 'Kommentar entfernt',
    'Subtask removed' => 'Unteraufgabe entfernt',
    '%s set a new internal link for the task #%d' => '%s hat einen neuen internen Link für die Aufgabe #%d hinzugefügt',
    '%s removed an internal link for the task #%d' => '%s hat einen internen Link für die Aufgabe #%d entfernt',
    'A new internal link for the task #%d have been defined' => 'Ein neuer interner Link für die Aufgabe #%d wurde erstellt',
    'Internal link removed for the task #%d' => 'Interner Link für die Aufgabe #%d entfernt',
    '%s set a new internal link for the task %s' => '%s hat einen neuen internen Link für die Aufgabe %s gesetzt',
    '%s removed an internal link for the task %s' => '%s hat einen internen Link für die Aufgabe %s entfernt',
    'Automatically set the due date on task creation' => 'Das Fälligkeitsdatum automatisch bei Erstellung der Aufgabe setzen',
    'Move the task to another column when closed' => 'Die Aufgabe in eine andere Spalte verschieben, wenn sie geschlossen wird',
    'Move the task to another column when not moved during a given period' => 'Die Aufgabe in eine anderen Spalte verschieben, wenn sie für einen angegebenen Zeitraum nicht verschoben wurde',
    'Dashboard for %s' => 'Dashboad für %s',
    'Tasks overview for %s' => 'Aufgabenübersicht für %s',
    'Subtasks overview for %s' => 'Unteraufgabenübersicht für %s',
    'Projects overview for %s' => 'Projektübersicht für %s',
    'Activity stream for %s' => 'Aktivitätenstream für %s',
    'Calendar for %s' => 'Kalender für %s',
    'Notifications for %s' => 'Benachrichtigungen für %s',
    'Subtasks export' => 'Unteraufgaben exportieren',
    'Tasks exportation' => 'Aufgaben exportieren',
);
